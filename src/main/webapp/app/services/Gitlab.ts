...
export class Gitlab implements OnInit {
    ...
    retrieveDeployments($maxPages: number): Observable<any> {
        ...
        this.http.get(this.URL + 'deployments', this.requestOptions(1, 100))
            ...
            .subscribe((res: Response) => {
                ...
                this.lastPage = parseInt(res.headers.get('X-Total-Pages'), 5);
    ...
    downloadFile($path): Observable<Response> {
        ...
        return this.http.get('https://gitlab.zaa.nttdata-labs.com/api/v3/projects/4/repository/files/configuration/local/config.properties?ref=develop-2.2',
            options);
    }
